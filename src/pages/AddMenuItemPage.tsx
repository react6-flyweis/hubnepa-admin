...
const defaultValues: AddMenuItemFormValues = {
  dishName: "",
  description: "",
  ingredients: "",
  restaurant: "",
...
export default function AddMenuItemPage() {
  ...
  function onSubmit(values: AddMenuItemFormValues) {
    form.reset(defaultValues)
    navigate("/products")
    void values
  }
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-0.5 text-muted-foreground">
                Create a new dish for a restaurant partner.
              </p>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <Card className="border border-slate-200 bg-white py-0">
            ...
            <CardContent className="space-y-4 px-5 pb-5">
              <p className="font-medium text-slate-900">Available for Order</p>
